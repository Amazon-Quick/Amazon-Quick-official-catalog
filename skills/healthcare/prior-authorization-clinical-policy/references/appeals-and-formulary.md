...
and appeal documentation. Apply internally; present the recommended strategy and its
justification.

## Formulary Exception Process

1. Standard exception: prescriber submits clinical rationale for a non-formulary drug.
...
## Appeal Levels (Medicare Part C/D)
...
| 3 | Administrative Law Judge (ALJ) | Amount in controversy at least 180 dollars (2024) |
| 4 | Medicare Appeals Council | No minimum amount |
| 5 | Federal District Court | Amount in controversy at least 1,760 dollars (2024) |

Medicare has distinct appeal levels, timelines, and amount-in-controversy thresholds.
Do not apply commercial appeal timelines to Medicare requests.

## Peer-to-Peer Review Best Practices

When preparing for a peer-to-peer review with the payer medical director:

1. Know the specific denial reason: request the denial letter and the clinical policy cited.
...
4. Document prior treatments: list all failed or tried therapies with dates and outcomes.
...
- Relevant clinical notes (last 6 to 12 months).
